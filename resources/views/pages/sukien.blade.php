            ...
            <div class="col-md-9 col-xs-12 rightcont"> <!--  start right content-->
                        <div class="row main-right ">
                            ...
                            <div class="col-md-3 grid-col">
                                ...
                                <a href="{!!route('interface-page-detail',['slug'=>$val->slug])!!}" class="grid-col-content">{{$val->title}}</a>
                                <a href="{!!route('interface-page-detail',['slug'=>$val->slug])!!}" class="layer-hover"></a>
                            </div> <!-- hết grid-col -->
                            @endforeach
                        </div> <!-- hết main-right -->
