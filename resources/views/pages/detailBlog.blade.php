        ...
        <div class=" row ">
            ...
            <div class="col-md-9 col-xs-12 rightcont">
                ...
                <div class="detai-title">
                    ...
                    <span>{{$detailBlog->title}}</span>
                    <?php \Carbon\Carbon::setLocale('vi')?>
                    <span>post by: {{$detailBlog->name}} {!! \Carbon\Carbon::createFromTimeStamp(strtotime($detailBlog->created_at))->diffforHumans() !!}</span>
                </div>
                <div class="row main-right" style="margin-bottom:35px;">
                    <img style="margin-bottom:35px;margin-top:15px;" src="{{asset('admin/img/'.$detailBlog->photo_cover)}}" alt="">
                    @if($detailBlog != null)
                    {!! $detailBlog->content !!}
                    @endif
                </div>
                ...
                <div>
                    ...
                    <div class="fb-like" data-href="{{ url("/detail-new/$detailBlog->slug") }}" data-width="" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
                </div>
                <div id="fb-root" style="margin-top: 30px;">
                    ...
                    <div class="fb-comments" data-href="{{ url("/detail-new/$detailBlog->slug") }}" data-numposts="5"></div>
                </div>
