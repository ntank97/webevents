...
<div class="content-wrapper">
    ...
    <div class="box-body">
        ...
        <form action="blogs-add-data" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box-body">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="tiêu đề bài viết" name="title" value="{!! old('title') !!}">
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail1">Tóm tắt nội dung</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="tóm tắt nội dung" name="short_cut" value="{!! old('short_cut') !!}">
                        </div>
                        <div class="form-group">
                        ...
                        <input name="author" type="text" class="form-control" id="exampleInputEmail1" placeholder="post user" disabled value="{!! \Auth::user()->name    !!}">
                        </div>
