...
<div class="content-wrapper">
    ...
    <div class="box-body">
        ...
        @endif
        <form action="intro-edit" method="POST" enctype="multipart/form-data">
            @if($intro != null)
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box-body">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Enter ..." id="editor1" name="content">{!! old('content',isset($intro) ? $intro->content : null) !!}</textarea>
                        <script>
