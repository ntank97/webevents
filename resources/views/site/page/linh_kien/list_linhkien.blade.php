          ...
          <div class="block block-layered-nav">
            ...
            <div class="block-content"> 
              <dl id="narrow-by-list">
                ...
                <dd class="odd">
                  <ol >
                    <li> <a href="{{url('tangdan')}}"><span class="t-text t-active">Giá Tăng Dần</span></a>  </li>
                    <li> <a href="{{url('giamdan')}}"><span class="t-text t-active">Giá Giảm Dần</span></a>  </li>
                    <li> <a href="{{url('az')}}"><span class="t-text t-active">Từ A - Z</span></a>  </li>
